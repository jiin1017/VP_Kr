...
UPDATE Language_ko_KR
SET Text = '투석기를 대체하는 로마의 고유 유닛입니다. 원거리에서 도시와 유닛에게 큰 피해를 줍니다. 적 영토에서[ICON_MOVES]이동력이 절반으로 감소합니다. 투석기보다 [ICON_RANGE_STRENGTH]원거리 공격력이 높습니다.'
...
UPDATE Language_ko_KR
SET Text = '야포는 매우 강력한 공성 유닛이며, 대포보다 더 강력하고 긴 사거리를 갖고 있습니다. 대포처럼 제한된 시야를 가지고 있으며 적 영토에서[ICON_MOVES]이동력이 절반으로 감소하지만, 원거리 공격력은 아주 강력합니다. 야포는 또한 "간접 사격" 능력을 갖추고 있는데, 이것은 시야 밖에 있는 장애물 너머의 적을 공격할 수 있습니다. (다른 아군으로 시야가 확보되었을 때만) 다른 공성 유닛처럼, 야포는 근접 공격에 취약합니다.'
...
UPDATE Language_ko_KR
SET Text = '당신의 문화에 {1_MinorCivName:textkey}{1: plural 1?이; 2?가;} 감명받았습니다! 그들은 이제 다른 문명의 문화는 쳐다보지도 않습니다. 성공한 문명(동점 허용):[NEWLINE]'
WHERE Tag = 'TXT_KEY_NOTIFICATION_QUEST_COMPLETE_CONTEST_CULTURE';

UPDATE Language_ko_KR
SET Text = '{1_MinorCivName:textkey}{1: plural 1?은; 2?는;} 다른 문명의 선진 문화에 감명받았습니다. 당신 문명의 문화 발전 속도가 충분하지 않습니다. 성공한 문명(동점 허용):[NEWLINE]'
...
UPDATE Language_ko_KR
SET Text = '{1_MinorCivName:textkey}{1: plural 1?은; 2?는;} 다른 문명의 깊은 신앙에 감명받았습니다. 당신 문명의 신앙 생성 속도가 충분하지 않습니다. 성공한 문명(동점 허용):[NEWLINE]'
...
UPDATE Language_ko_KR
SET Text = '{1_MinorCivName:textkey}{1: plural 1?은; 2?는;} 다른 문명의 첨단 기술에 감명받았습니다. 당신 문명의 기술 발전 속도가 충분하지 않습니다. 성공한 문명(동점 허용):[NEWLINE]'
...
UPDATE Language_ko_KR
SET Text = '{1_SpyRank} {2_SpyName}{2: plural 1?이; 2?가;} {3_CityName}에서 기술을 훔칠 수 없습니다.[NEWLINE][NEWLINE]{4_CityName}의 기본 잠재력은 {5_Num}입니다.[NEWLINE][NEWLINE]잠재력이 높을수록 도시는 취약합니다. 기본값은 [COLOR_POSITIVE_TEXT](1~10값,보정됨)[ENDCOLOR] 도시의 전반적인 번영과 행복, 특히 과학과 골드 산출량에 기초합니다. 도시에 경찰대나 경찰서와 같은 방어 건물을 건설하면 잠재력이 감소합니다. 도시에 경찰대나 경찰서와 같은 방어 건물이 있으면 잠재력이 감소합니다.'
