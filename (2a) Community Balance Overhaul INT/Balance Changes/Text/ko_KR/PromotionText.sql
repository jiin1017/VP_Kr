 ...
 -- added Withdraw Before Melee
	UPDATE Language_ko_KR
	SET Text = '근접 전투 시 후퇴 확률 [COLOR_POSITIVE_TEXT]80%[ENDCOLOR] [COLOR:105:105:105:255](빠른 적 유닛 또는 유닛 뒤에 제한된 평지가 있을 경우 후퇴 확률 감소)'
...
-- added Combat Bonus in forest/jungle (33) Jaguar
 ...
 -- added Heroism
	...
	UPDATE Language_ko_KR
	SET Text = '설원, 툰드라, 언덕에서 [ICON_STRENGTH]전투력 보너스 [COLOR_POSITIVE_TEXT]+25%[ENDCOLOR][NEWLINE][COLOR:105:105:105:255](숲 또는 정글 존재 시 보너스 없음)[ENDCOLOR][NEWLINE]설원, 툰드라, 언덕에서 [ICON_MOVES]이동력 [COLOR_POSITIVE_TEXT]두 배[ENDCOLOR]'
	...
	UPDATE Language_ko_KR
	SET Text = '[ICON_CAPITAL]수도에서 전투 시 [ICON_STRENGTH]전투력 보너스 [COLOR_POSITIVE_TEXT]+30%[ENDCOLOR][NEWLINE][COLOR:105:105:105:255](멀어질수록 전투력 감소)[ENDCOLOR]'
...
-- 규율
	...
	UPDATE Language_ko_KR
	SET Text = '[ICON_STRENGTH]전투력 보너스 [COLOR_POSITIVE_TEXT]+15%[ENDCOLOR][NEWLINE]근접 전투 시 적 유닛에 [COLOR_PLAYER_PURPLE]승선 I[ENDCOLOR] [COLOR:105:105:105:255](적 [ICON_MOVES]이동력 -2)[ENDCOLOR] 상태를 부여'
	...
	UPDATE Language_ko_KR
	SET Text = '[ICON_STRENGTH]전투력 보너스 [COLOR_POSITIVE_TEXT]+15%[ENDCOLOR][NEWLINE]근접 전투 시 적 유닛에 [COLOR_PLAYER_PURPLE]승선 II[ENDCOLOR] [COLOR:105:105:105:255](적 [ICON_MOVES]이동력 -4)[ENDCOLOR] 상태를 부여'
...
-- fixed spear throw
	UPDATE Language_ko_KR
	SET Text = '화약 유닛 대항 시 [ICON_STRENGTH]전투력 보너스 [COLOR_POSITIVE_TEXT]+25%[ENDCOLOR][NEWLINE]근접 전투 돌입 전 추가 원거리 공격[NEWLINE][NEWLINE][COLOR_NEGATIVE_TEXT]업그레이드 시 소멸[ENDCOLOR]'
...
-- Air Ambush - More Interceptions
	...
	-- City Siege
	UPDATE Language_ko_KR
	SET Text = '도시 공격 시 [ICON_STRENGTH]전투력 보너스 [COLOR_POSITIVE_TEXT]+100%[ENDCOLOR][NEWLINE][NEWLINE][COLOR_NEGATIVE_TEXT]업그레이드 시 소멸[ENDCOLOR]'
	...
	UPDATE Language_ko_KR
	SET Text = '도시 공격 시 [ICON_STRENGTH]전투력 보너스 [COLOR_POSITIVE_TEXT]+150%[ENDCOLOR][NEWLINE][NEWLINE][COLOR_NEGATIVE_TEXT]업그레이드 시 소멸[ENDCOLOR]'
	...
	UPDATE Language_ko_KR
	SET Text = '[COLOR_RESEARCH_STORED]나침반[ENDCOLOR] 연구 전까지 대양에서 턴을 끝낼 수 없음[NEWLINE]연안에서 턴 종료 시 대양 타일 통과 가능[NEWLINE][NEWLINE][COLOR_NEGATIVE_TEXT]업그레이드 시 소멸[ENDCOLOR]'
...
-- 병참
	...
	UPDATE Language_ko_KR
	SET Text = '공격 시 [ICON_RANGE_STRENGTH]원거리 전투력 [COLOR_NEGATIVE_TEXT]-10%[ENDCOLOR][NEWLINE]장애물 넘어 [ICON_RANGE_STRENGTH]원거리 공격 가능 [COLOR:105:105:105:255](시야 확보 시)[ENDCOLOR]'
...
INSERT INTO Language_ko_KR (Tag, Text)
VALUES ('TXT_KEY_PROMOTION_STEAM_POWERED', '연안 지형 보너스');
