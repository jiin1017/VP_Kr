...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]미래파[ENDCOLOR]: 역사적 사건에서 오는 [ICON_TOURISM]관광 보너스가 [COLOR_POSITIVE_TEXT]20%[ENDCOLOR] 증가하고 모든 [ICON_GREAT_WORK]걸작에서 오는 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 도시를 점령했을 때 [ICON_TOURISM]관광을 [COLOR_POSITIVE_TEXT]50[ENDCOLOR] 제공합니다. 이 효과는 도시별로 한 번만 적용됩니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]시민 사회[ENDCOLOR]: 전문가가 소모하는 [ICON_FOOD]식량이 평소보다 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] (한도:1[ICON_FOOD]) 감소합니다.'
...
-- Piety Opener
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]충성[ENDCOLOR]은 [ICON_RELIGION]종교, 도시 인프라, 성장에 초점을 맞춘 제국에 적합합니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]정책 개방 보너스:[ENDCOLOR][NEWLINE][ICON_BULLET] [ICON_PEACE]신앙으로 [COLOR_YELLOW]수도원[ENDCOLOR] 구매 가능[NEWLINE][ICON_BULLET] [ICON_PEACE]신앙으로 건물, 선교사, 이단심문관 구매 시 비용 -25%[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]각 정책 채택 보너스:[ENDCOLOR][NEWLINE][ICON_BULLET] 모든 도시의 [ICON_FOOD]식량 및 [ICON_STRENGTH]전투력 +1[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]계열 완성 보너스:[ENDCOLOR][NEWLINE][ICON_BULLET] [COLOR_YELLOW]붉은 요새[ENDCOLOR] 불가사의 건설 가능[NEWLINE][ICON_BULLET] 같은 종교에서 오는 [ICON_TOURISM]관광 +25%[NEWLINE][ICON_BULLET] 대중[ICON_RELIGION]종교를 따르는 도시의 [ICON_RESEARCH]과학, [ICON_PEACE]신앙, [ICON_PRODUCTION]생산, [ICON_CULTURE]문화 +30[NEWLINE][ICON_BULLET] [ICON_BULLET] 산업 시대 이후 [ICON_PEACE]신앙으로 [ICON_GREAT_ARTIST]위대한 예술가 구매 가능'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]경험주의[ENDCOLOR][NEWLINE]모든 도시에서 적[ICON_SPY]스파이의 효율이 34% 감소합니다. 전문가가 소모하는 [ICON_FOOD]식량이 평소보다 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] (한도:1[ICON_FOOD]) 감소합니다.'
...
-- Free Thought
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]자유사상[ENDCOLOR][NEWLINE][ICON_GREAT_SCIENTIST]위대한 과학자를 소모해 기술 연구 시 얻는 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 증가합니다. [ICON_GREAT_ADMIRAL]위대한 제독을 소모할 때 고유 사치 자원의 [COLOR_POSITIVE_TEXT]복제품[ENDCOLOR]을 2개 제공합니다. 모든 도시의 [ICON_PEACE]종교 분쟁에서 오는 [ICON_HAPPINESS_3]불행이 절반 감소합니다.'
...
-- Aristocracy
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]정의[ENDCOLOR][NEWLINE]모든 도시의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가하고 유닛이 주둔한 도시의 [ICON_RANGE_STRENGTH]원거리 공격력이 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 증가합니다. [ICON_CAPITAL]수도에 근위병 초소가 출현합니다.'
...
-- Oligarchy
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]주권[ENDCOLOR][NEWLINE]새로운 타일을 확보하기 위해 필요한 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]20%[ENDCOLOR] 감소합니다. [ICON_CAPITAL]수도에 궁정 예배당이 출현합니다.'
...
-- Monarchy
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]존엄[ENDCOLOR][NEWLINE][ICON_CAPITAL]수도의 전문가가 소모하는 [ICON_FOOD]식량이 평소보다 [COLOR_POSITIVE_TEXT]절반[ENDCOLOR] (한도:1[ICON_FOOD]) 감소합니다. [ICON_CAPITAL]수도에 국고가 출현합니다.'
...
-- Landed Elite
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]탁월[ENDCOLOR][NEWLINE]위인을 소모할 때 [ICON_GOLDEN_AGE]황금기 점수 및 [ICON_CULTURE]문화를 [COLOR_POSITIVE_TEXT]50[ENDCOLOR] (시대별 보정) 제공합니다. [ICON_CAPITAL]수도에 궁정 정원이 출현합니다.'
...
-- Legalism
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]의식[ENDCOLOR][NEWLINE]모든 국가 불가사의의 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. [ICON_CAPITAL]수도에 궁정 점술사가 출현합니다.'
