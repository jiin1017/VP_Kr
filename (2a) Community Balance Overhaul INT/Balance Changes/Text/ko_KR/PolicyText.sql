...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]시민 사회[ENDCOLOR]: 전문가가 소모하는 [ICON_FOOD]식량이 평소보다 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] [COLOR:130:130:130:255](한도: [ICON_FOOD]1)[ENDCOLOR] 감소합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]비밀 공작[ENDCOLOR]: 도시 국가의 선거 조작 및 쿠데타 성공 확률이 [COLOR_POSITIVE_TEXT]두 배[ENDCOLOR] 증가합니다. 추가 [ICON_SPY][COLOR_YELLOW]스파이[ENDCOLOR]를 1명 또는 그 이상 [COLOR:130:130:130:255]([ICON_CITY_STATE]도시 국가 수에 기반)[ENDCOLOR] 제공합니다.'
...
-- Treaty Organization
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]조약 기구[ENDCOLOR]: [ICON_INTERNATIONAL_TRADE]교역로가 연결된 도시 국가 1개마다 [COLOR:130:130:130:255](한도: 10)[ENDCOLOR] 해당 도시 국가에 대한 [ICON_INFLUENCE]영향력이 매 턴 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 세계 대회 추가 [COLOR_YELLOW]대표단[ENDCOLOR]을 4명 [COLOR:130:130:130:255](맵 크기별 보정)[ENDCOLOR] 확보합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]이중 간첩[ENDCOLOR]: 추가 [ICON_SPY][COLOR_YELLOW]스파이[ENDCOLOR]를 3명 또는 그 이상 [COLOR:130:130:130:255]([ICON_CITY_STATE]도시 국가 수에 기반)[ENDCOLOR] 제공합니다. 당신 문명의 [ICON_SPY]스파이가 적[ICON_SPY]스파이를 포획할 확률이 [COLOR_POSITIVE_TEXT]두 배[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]문화유산[ENDCOLOR][NEWLINE]세계 불가사의 또는 국가 불가사의 건설을 완료하면 황금기 점수를 [COLOR_POSITIVE_TEXT]100[ENDCOLOR] [COLOR:130:130:130:255](시대별 보정)[ENDCOLOR] 제공합니다. 모든 대학의 [ICON_GOLDEN_AGE]황금기 점수 및 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]4[ENDCOLOR] 증가합니다.'
...
-- Artistic Genius
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]국보[ENDCOLOR][NEWLINE][ICON_CAPITAL]수도 근처에 원하는 [ICON_GREAT_PEOPLE][COLOR_YELLOW]위인[ENDCOLOR]이 1명 출현합니다. [ICON_GREAT_PEOPLE]위인을 소모할 때 [ICON_GOLD]골드를 [COLOR_POSITIVE_TEXT]50[ENDCOLOR] [COLOR:130:130:130:255](시대별 보정)[ENDCOLOR] 제공합니다.'
...
-- Mercantilism
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]중상주의[ENDCOLOR][NEWLINE]건물을 건설할 때 [ICON_RESEARCH]과학을 [COLOR_POSITIVE_TEXT]10[ENDCOLOR] [COLOR:130:130:130:255](시대별 보정)[ENDCOLOR] 제공합니다. 모든 시장, 대상 숙소, 세관, 은행, 증권거래소의 [ICON_RESEARCH]과학 및 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]3%[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]집행권[ENDCOLOR][NEWLINE][ICON_CAPITAL]수도 근처에 무료 [COLOR_YELLOW]개척자[ENDCOLOR]가 1명 출현합니다. 새로운 도시를 개척하거나 점령할 때 [ICON_RESEARCH]과학 및 [ICON_CULTURE]문화를 [COLOR_POSITIVE_TEXT]40[ENDCOLOR] [COLOR:130:130:130:255](시대별 보정)[ENDCOLOR] 제공합니다. 정복 보너스는 도시의 [ICON_CITIZEN]시민 수에 따라 달라집니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]공물[ENDCOLOR][NEWLINE]도시의 국경이 확장될 때 [ICON_GOLD]골드 및 [ICON_PRODUCTION]생산을 [COLOR_POSITIVE_TEXT]20[ENDCOLOR] [COLOR:130:130:130:255](시대별 보정)[ENDCOLOR] 제공합니다. [ICON_CITY_STATE]도시 국가에 요구한 공물의 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR]에 해당하는 [ICON_CULTURE]문화를 [ICON_CAPITAL]수도에 제공합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]진보[ENDCOLOR]는 탄탄한 사회 기반 시설과 과학 발전을 원하는 문명에 적합합니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]정책 개방 보너스:[ENDCOLOR][NEWLINE][ICON_BULLET] [ICON_CAPITAL]수도의 [ICON_CITIZEN]시민이 태어날 때 [ICON_RESEARCH]과학 20[NEWLINE][ICON_BULLET] [ICON_CAPITAL]수도의 [ICON_CITIZEN]시민 1명마다 [ICON_RESEARCH]과학 15 [COLOR:130:130:130:255](시대별 보정)[ENDCOLOR][NEWLINE][ICON_BULLET] 기술 발견 시 [ICON_CULTURE]문화 15 [COLOR:130:130:130:255](시대별 보정)[ENDCOLOR][NEWLINE][ICON_BULLET] 이미 발견된 기술마다 [ICON_CULTURE]문화 15[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]각 정책 채택 보너스:[ENDCOLOR] [NEWLINE][ICON_BULLET] 기술 발견 시 [ICON_CULTURE]문화 15 [COLOR:130:130:130:255](시대별 보정)[ENDCOLOR][NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]계열 완성 보너스:[ENDCOLOR][NEWLINE][ICON_BULLET] [COLOR_YELLOW]자금성[ENDCOLOR] 불가사의 건설 가능[NEWLINE][ICON_BULLET] [ICON_CITIZEN]시민이 태어날 때 [ICON_GOLD]골드 25 [COLOR:130:130:130:255](시대별 보정)[ENDCOLOR][NEWLINE][ICON_BULLET] 산업 시대 이후 [ICON_PEACE]신앙으로 [ICON_GREAT_WRITER][COLOR_YELLOW]위대한 작가[ENDCOLOR] 구매 가능'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]전문화[ENDCOLOR][NEWLINE]건물을 건설할 때 [ICON_PRODUCTION]생산 보너스를 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 제공합니다. 건물 건설을 완료하면 [ICON_CULTURE]문화를 [COLOR_POSITIVE_TEXT]10[ENDCOLOR] [COLOR:130:130:130:255](시대별 보정)[ENDCOLOR] 제공합니다.'
...
-- Philanthropy
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]외교국[ENDCOLOR][NEWLINE]추가 [ICON_SPY][COLOR_YELLOW]스파이[ENDCOLOR]를 1명 또는 그 이상 [COLOR:130:130:130:255]([ICON_CITY_STATE]도시 국가 수에 기반)[ENDCOLOR] 제공합니다. 도시 국가의 퀘스트 보상이 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR] 증가합니다. 교역로에서 오는 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]무역연합[ENDCOLOR][NEWLINE]모든 [ICON_INTERNATIONAL_TRADE]교역로의 산출량이 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 증가합니다. [ICON_INTERNATIONAL_TRADE]교역로가 연결된 도시 국가와의 [ICON_INFLUENCE]영향력이 매 턴 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] [COLOR:130:130:130:255](한도: 5)[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]과학혁명[ENDCOLOR][NEWLINE]모든 도시에 천문대를 건설할 수 있습니다. 모든 정글 타일의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가하고 현재 소유한 [ICON_GREAT_WORK]걸작 1개마다 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]3%[ENDCOLOR] [COLOR:130:130:130:255](한도: 20%)[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]경험주의[ENDCOLOR][NEWLINE]모든 도시에서 적[ICON_SPY]스파이의 효율이 [COLOR_POSITIVE_TEXT]34%[ENDCOLOR] 감소합니다. 전문가가 소모하는 [ICON_FOOD]식량이 평소보다 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] [COLOR:130:130:130:255](한도: [ICON_FOOD]1)[ENDCOLOR] 감소합니다.'
...
-- Monarchy
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]존엄[ENDCOLOR][NEWLINE][ICON_CAPITAL]수도의 전문가가 소모하는 [ICON_FOOD]식량이 평소보다 [COLOR_POSITIVE_TEXT]절반[ENDCOLOR] [COLOR:130:130:130:255](한도: [ICON_FOOD]1)[ENDCOLOR] 감소합니다. [ICON_CAPITAL]수도에 [COLOR_YELLOW]국고[ENDCOLOR]가 출현합니다.'
...
-- Landed Elite
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]탁월[ENDCOLOR][NEWLINE][ICON_GREAT_PEOPLE]위인을 소모할 때 [ICON_GOLDEN_AGE]황금기 점수 및 [ICON_CULTURE]문화를 [COLOR_POSITIVE_TEXT]50[ENDCOLOR] [COLOR:130:130:130:255](시대별 보정)[ENDCOLOR] 제공합니다. [ICON_CAPITAL]수도에 [COLOR_YELLOW]궁정 정원[ENDCOLOR]이 출현합니다.'
