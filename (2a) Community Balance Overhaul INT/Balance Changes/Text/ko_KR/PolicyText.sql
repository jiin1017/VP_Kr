...
-- Creative Expression
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]독창적 표현[ENDCOLOR]: [ICON_GREAT_WORK]걸작에서 오는 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 모든 박물관, 방송탑, 오페라 극장, 원형극장의 [ICON_GOLDEN_AGE]황금기 점수가 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.'
...
-- Artistic Genius
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]국보[ENDCOLOR][NEWLINE][ICON_CAPITAL]수도 근처에 원하는 [ICON_GREAT_PEOPLE]위인이 1명 출현합니다. [ICON_GREAT_PEOPLE]위인을 소모할 때 [ICON_GOLD]골드를 [COLOR_POSITIVE_TEXT]50[ENDCOLOR] (시대별 보정) 제공합니다.'
...
-- Cultural Exchange
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]문화 교류[ENDCOLOR][NEWLINE]다른 문명과의 [COLOR_POSITIVE_TEXT]국경 개방[ENDCOLOR에서 오는 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 증가합니다. 모든 원형극장 및 오페라 극장의 [ICON_CULTURE]문화 및 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. [ICON_GOLDEN_AGE]황금기 동안 모든 도시의 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]산업[ENDCOLOR]은 제국의 [ICON_GOLD]골드 및 [ICON_PRODUCTION]생산에 초점을 맞춘 보너스를 제공합니다.[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]정책 개방 보너스:[ENDCOLOR][NEWLINE][ICON_BULLET] 철도역 및 항구 건설 시 [ICON_PRODUCTION]생산 보너스 +100%[NEWLINE][ICON_BULLET] 구매에 필요한 [ICON_GOLD]골드 비용 -5%[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]각 정책 채택 보너스:[ENDCOLOR][NEWLINE][ICON_BULLET] 구매에 필요한 [ICON_GOLD]골드 비용 -5%[NEWLINE][NEWLINE][COLOR_POSITIVE_TEXT]계열 완성 보너스:[ENDCOLOR][NEWLINE][ICON_BULLET] [COLOR_YELLOW]브로드웨이[ENDCOLOR] 건설 가능[NEWLINE][ICON_BULLET] 모든 사치 자원의 전역 [ICON_HAPPINESS_1]행복 두 배[NEWLINE][ICON_BULLET] 전문가의 [ICON_PRODUCTION]생산 및 [ICON_GOLD]골드 +2[NEWLINE][ICON_BULLET] 산업 시대 이후 [ICON_PEACE]신앙으로 [ICON_GREAT_MERCHANT]위대한 상인 구매 가능'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]자유무역[ENDCOLOR][NEWLINE][ICON_GREAT_MERCHANT]위대한 상인 출현율이 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR] 증가합니다. [ICON_INTERNATIONAL_TRADE]]교역로의 골드가 [COLOR_POSITIVE_TEXT]5[ENDCOLOR] 증가합니다. 모든 도시의 [ICON_GOLD]빈곤에서 오는 전역 [ICON_HAPPINESS_3]불행 반영값이 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 감소합니다.'
...
-- Mercantilism
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]중상주의[ENDCOLOR][NEWLINE]건물을 건설할 때 [ICON_RESEARCH]과학을 [COLOR_POSITIVE_TEXT]10[ENDCOLOR] (시대별 보정) 제공합니다. 모든 시장, 대상 숙소, 세관, 은행, 증권거래소의 [ICON_RESEARCH]과학 및 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]3%[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]보호무역주의[ENDCOLOR][NEWLINE]추가 [ICON_INTERNATIONAL_TRADE]교역로를 2개 제공합니다. 국제 교역로의 산출량이 [COLOR_POSITIVE_TEXT]33%[ENDCOLOR] 증가합니다. "국왕 경축일"이 열리는 동안 [ICON_FOOD]식량 및 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]계엄령[ENDCOLOR][NEWLINE][ICON_PUPPET]괴뢰 도시의 산출량 페널티가 [COLOR_NEGATIVE_TEXT]80%[ENDCOLOR에서 [COLOR_POSITIVE_TEXT]60%[ENDCOLOR]로 감소합니다. 모든 경찰대의 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 더이상 도시에 주둔한 유닛의 [ICON_GOLD]유지비가 들지 않습니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]문명화 사명[ENDCOLOR][NEWLINE]도시를 점령할 때 대량의 [ICON_GOLD]골드를 제공합니다. [ICON_PUPPET]괴뢰 도시 및 법원이 있는 도시에서 건물을 생산할 때 [ICON_PRODUCTION]생산 보너스를 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 제공하고 현재 시대와 건물의 시대 사이의 차이마다 추가적으로 [ICON_PRODUCTION]생산 보너스를 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 제공합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]집행권[ENDCOLOR][NEWLINE][ICON_CAPITAL]수도 근처에 무료 개척자가 1명 출현합니다. 도시를 개척하거나 점령할 때 [ICON_RESEARCH]과학 및 [ICON_CULTURE]문화를 [COLOR_POSITIVE_TEXT]40[ENDCOLOR] (시대별 보정) 제공합니다. 정복 시 보너스는 도시의 [ICON_CITIZEN]시민 수에 따라 달라집니다'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]공물[ENDCOLOR][NEWLINE]도시의 국경이 확장될 때 [ICON_GOLD]골드 및 [ICON_PRODUCTION]생산을 [COLOR_POSITIVE_TEXT]20[ENDCOLOR] (시대별 보정) 제공합니다. 도시 국가에 요구한 공물의 25%에 해당하는 [ICON_CULTURE]문화를 [ICON_CAPITAL]수도에 제공합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]지배[ENDCOLOR][NEWLINE]적 유닛을 처치할 때 처치한 유닛의 [ICON_STRENGTH]전투력 만큼 [ICON_RESEARCH]과학을 제공합니다. 적 군사 유닛을 처치한 근접 유닛이 체력을 [COLOR_POSITIVE_TEXT]15[ENDCOLOR] 회복합니다.
유닛 공급 

Unit Supply generated by [ICON_CITIZEN] Population increased by 10%.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]규율[ENDCOLOR][NEWLINE]유닛이 주군한 도시에서 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 유닛 유지비가 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 감소하고 도로의 유지비가 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR] 감소합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]명예[ENDCOLOR][NEWLINE]유닛의 [ICON_STRENGTH]전투력 보너스가 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 증가합니다. 모든 도시에 [ICON_CITIZEN]시민 10명마다 보급 한도를 차지하지 않는 군사 유닛이 출현합니다. [ICON_WAR]전쟁 피로도가 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 감소합니다.'
...
-- Foreign Legion Text
UPDATE Language_ko_KR
SET Text = '현대 시대의 특수 보병 유닛입니다. 이 유닛은 우호 지역 밖에서 [ICON_STRENGTH]전투력 보너스가 증가하는 것 외에는 소총병과 매우 비슷합니다. 구매 시 승급에 필요한 충분한 경험치를 제공합니다. [COLOR_MAGENTA]권위[ENDCOLOR] 정책을 완성한 후 [ICON_GOLD]골드로 구매할 수 있습니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]전문화[ENDCOLOR][NEWLINE]건물을 건설할 때 [ICON_PRODUCTION]생산 보너스를 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 제공합니다. 건물 건설을 완료하면 [ICON_CULTURE]문화를 [COLOR_POSITIVE_TEXT]10[ENDCOLOR] (시대별 보정) 제공합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]평등[ENDCOLOR][NEWLINE]모든 도시의 [ICON_HAPPINESS_1[행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 도시의 [ICON_CITIZEN]시민 15명마다 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다. 모든 도시의 [ICON_GOLD]빈곤, [ICON_RESEARCH]문맹, [ICON_CULTURE]무료, [ICON_FOOD]/[ICON_PRODUCTION]곤경에서 오는 [ICON_HAPPINESS_3]불행 반영값이 [COLOR_POSITIVE_TEXT]10%[ENDCOLOR] 감소합니다.'
...
-- Philanthropy
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]외교국[ENDCOLOR][NEWLINE]추가 [ICON_SPY][COLOR_POSITIVE_TEXT]스파이[ENDCOLOR]를 1명 또는 그 이상 ([ICON_CITY_STATE]도시 국가 수에 기반) 제공합니다. 도시 국가의 퀘스트 보상이 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR] 증가합니다. 교역로에서 오는 [ICON_TOURISM]관광이 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 증가합니다.'
...
-- Consulates
UPDATE Language_ko_KR
SET Text ='[COLOR_POSITIVE_TEXT]영사관[ENDCOLOR][NEWLINE][ICON_CITY_STATE]도시 국가 8개마다 세계 대회 추가 대표단을 [COLOR_POSITIVE_TEXT]1명[ENDCOLOR] 확보합니다. 도시 국가로 향하는 [ICON_INTERNATIONAL_TRADE]교역로가 완성되면 알려진 모든 문명에 대한 [ICON_TOURISM\관광 보너스가 증가합니다.'
...
-- Scholasticism
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]그림자 네트워크[ENDCOLOR][NEWLINE]동맹인 도시 국가가 산출하는 [ICON_RESEARCH]과학의 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR]를 획득합니다. 모든 활동중인 [ICON_SPY]스파이 또는 [ICON_DIPLOMAT]외교관 1명마다 [ICON_CAPITAL]수도의 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]3%[ENDCOLOR] (최대: 30%까지) 증가합니다. 모든 전문가의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가하고 모든 경찰대 및 경찰서의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]3[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]외환 시장[ENDCOLOR][NEWLINE]도시 국가가 제공하는 자원이 독점에 계산 됩니다. 추가 [ICON_INTERNATIONAL_TRADE]교역로를 1개 제공하고 활성화된 교역로 1개마다 [ICON_HAPPINESS_1]행복이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]무역연합[ENDCOLOR][NEWLINE]모든 [ICON_INTERNATIONAL_TRADE]교역로의 산출량이 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR] 증가합니다. [ICON_INTERNATIONAL_TRADE]교역로가 연결된 도시 국가와의 영향력이 매 턴 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] (한도: 5) 증가합니다.'
...
-- Organized Religion
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]종교 체제[ENDCOLOR][NEWLINE]당신의 대중 [ICON_RELIGION]종교가 아닌 주변 모든 도시에 대한 종교 압력이 [COLOR_POSITIVE_TEXT]50%[ENDCOLOR] 증가합니다. 모든 전문가의 [ICON_PEACE]신앙이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]신성한 권리[ENDCOLOR][NEWLINE]매 턴 도시 [ICON_HAPPINESS_1]행복의 [COLOR_POSITIVE_TEXT]25%[ENDCOLOR]가 [ICON_CULTURE]문화로 전환됩니다. [ICON_CULTURE]무료에서 오는 전역 [ICON_HAPPINESS_3]불행 반영값이 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 감소합니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]부르주아[ENDCOLOR][NEWLINE]"국왕 경축일"이 열리는 동안 도시의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]15%[ENDCOLOR] 국경 확장 속도가 [COLOR_POSITIVE_TEXT]두 배[ENDCOLOR] 증가합니다. 전문가 [COLOR_POSITIVE_TEXT]1명[ENDCOLOR]이 더이상 도시화에서 오는 [ICON_HAPPINESS_3]불행을 제공하지 않습니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]과학혁명[ENDCOLOR][NEWLINE]모든 도시에 천문대를 건설할 수 있습니다. 모든 정글 타일의 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가하고, 현재 소유한 [ICON_GREAT_WORK]걸작마다 [ICON_RESEARCH]과학이 [COLOR_POSITIVE_TEXT]3%[ENDCOLOR] (한도:20%) 증가합니다.'
...
-- Landed Elite
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]탁월[ENDCOLOR][NEWLINE]Expending a Great Person grants 50 [ICON_GOLDEN_AGE] Golden Age Points and [ICON_CULTURE] Culture, scaling with Era. [COLOR_POSITIVE_TEXT]Palace Garden[ENDCOLOR] built in [ICON_CAPITAL] Capital (1 Writer Specialist, 1 [ICON_GREAT_WORK] Great Work of Writing slot, +5 [ICON_FOOD] Food; Monuments, Gardens, and Baths provide +2 [ICON_CULTU 뇆 ㅡㄷ 솓 ㅡㅐㅜ됴RE] Culture in every City).'
