...
-- Monastery
UPDATE Language_ko_KR
SET Text = '종교 건물을 [ICON_PEACE]신앙으로 구입할 수 있습니다. 도시의 [ICON_FOOD]식량, [ICON_RESEARCH]과학, [ICON_PEACE]신앙을 증가시킵니다.[NEWLINE][NEWLINE] [COLOR_MAGENTA]충성[ENDCOLOR] 정책을 채택해야 건설할 수 있습니다.'
