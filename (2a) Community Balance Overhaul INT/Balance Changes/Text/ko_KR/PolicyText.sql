...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]미래파[ENDCOLOR]: "역사적 사건"에서 오는 [ICON_TOURISM]관광 보너스가 [COLOR_POSITIVE_TEXT]20%[ENDCOLOR] 증가하고 모든 [ICON_GREAT_WORK]걸작에서 오는 [ICON_CULTURE]문화가 [COLOR_POSITIVE_TEXT]2[ENDCOLOR] 증가합니다. 도시를 정복했을 때 [ICON_TOURISM]관광을 [COLOR_POSITIVE_TEXT]50[ENDCOLOR] 제공합니다. 이 효과는 도시별로 한 번만 적용됩니다.'
...
UPDATE Language_ko_KR
SET Text = '[COLOR_POSITIVE_TEXT]집행권[ENDCOLOR][NEWLINE][ICON_CAPITAL]수도 근처에 무료 [COLOR_YELLOW]개척자[ENDCOLOR]가 1명 출현합니다. 새로운 도시를 개척하거나 정복할 때 [ICON_RESEARCH]과학 및 [ICON_CULTURE]문화를 [COLOR_POSITIVE_TEXT]40[ENDCOLOR] [COLOR:110:110:110:255](시대별 보정)[ENDCOLOR] 제공합니다. 정복 보너스는 도시의 [ICON_CITIZEN]시민 수에 따라 달라집니다.'
