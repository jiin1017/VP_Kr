...
UPDATE Language_ko_KR
SET Text = '헥손 정유 프랜차이즈를 설립한 도시 주변 모든 [ICON_RES_COAL] 석탄 자원, [ICON_RES_OIL] 석유 자원, [ICON_RES_INCENSE] 향, [ICON_RES_URANIUM] 우라늄 자원, [ICON_RES_BRAZILWOOD]브라질 소방목, [ICON_RES_PERFUME] 향수, [ICON_RES_GLASS] 유리 의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'
WHERE Tag = 'TXT_KEY_CORPORATION_RESOURCE_BONUS_HEXXON_REFINERY';
 
-- LandSea Extractors
 
UPDATE Language_ko_KR
SET Text = '센타우리 개발 프랜차이즈를 설립한 도시 주변 모든 [ICON_RES_HORSE] 말 자원, [ICON_RES_WHALE] 고래, [ICON_RES_CRAB] 게, [ICON_RES_IVORY] 상아, [ICON_RES_CORAL] 산호의 [ICON_PRODUCTION]생산이 [COLOR_POSITIVE_TEXT]1[ENDCOLOR] 증가합니다.'
